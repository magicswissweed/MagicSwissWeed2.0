...
public class Keys {
    ...
    public static final UniqueKey<ForecastTableRecord> UNIQUE_FORECAST = Internal.createUniqueKey(ForecastTable.FORECAST_TABLE, DSL.name("unique_forecast"), new TableField[] { ForecastTable.FORECAST_TABLE.TIMESTAMP, ForecastTable.FORECAST_TABLE.STATIONID }, true);
    ...
    public static final UniqueKey<SampleTableRecord> UNIQUE_SAMPLE = Internal.createUniqueKey(SampleTable.SAMPLE_TABLE, DSL.name("unique_sample"), new TableField[] { SampleTable.SAMPLE_TABLE.TIMESTAMP, SampleTable.SAMPLE_TABLE.STATIONID }, true);
