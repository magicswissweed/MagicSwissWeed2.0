...
public class PublicSpotListConfiguration {
    ...
    public static final Set<Spot> PUBLIC_BUNGEE_SURF_SPOTS = Set.of(
            new Spot(new SpotId(), true, SpotTypeEnum.BUNGEE_SURF, "Zürich", apiStationId(Country.CH, "2243"), ApiMeasurementType.FLOW, 75.0, 350.0),
            new Spot(new SpotId(), true, SpotTypeEnum.BUNGEE_SURF, "Bern", apiStationId(Country.CH, "2135"), ApiMeasurementType.FLOW, 80.0, 360.0),
            new Spot(new SpotId(), true, SpotTypeEnum.BUNGEE_SURF, "Luzern", apiStationId(Country.CH, "2152"), ApiMeasurementType.FLOW, 80.0, 350.0),
            new Spot(new SpotId(), true, SpotTypeEnum.BUNGEE_SURF, "Basel", apiStationId(Country.CH, "2091"), ApiMeasurementType.FLOW, 850.0, 2500.0),
            new Spot(new SpotId(), true, SpotTypeEnum.BUNGEE_SURF, "St. Gallen", apiStationId(Country.CH, "2473"), ApiMeasurementType.FLOW, 130.0, 1300.0)
    );
